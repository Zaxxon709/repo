...
<ul>
    ...
    <li>From the available list of sources, select "709Repo", and install the appropriate repo for your Kodi installation. "repository.709-leia-1.1.zip" or "repository.709-matrix-1.0.zip"</li>
</ul>
